...
top_fig = px.bar(avg_annual_incidents_per_station.sort_values(by='IncidentNumber',ascending=False)[:5], x="IncidentNumber", y="DeployedFromStation_Name", orientation='h',ascending='False')
